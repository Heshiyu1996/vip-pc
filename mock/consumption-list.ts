...
function getConsumptionList(req: Request, res: Response, u: string) {
  let realUrl = u;
...
function removeConsumptionList(req: Request, res: Response, u: string, b: Request) {
  const result = {
    success: true,
    message: '删除成功',
    data: {}
...
function exportConsumptionList(req: Request, res: Response, u: string, b: Request) {
  const result = {
    success: true,
    message: '导出成功',
    data: "http://www.xlsx"
